...
Getting started with WPNative Apps consists of two steps:
1. Installing the **WP Native Apps** Plugin
1. Configuring the Settings after installation

### INSTALL WP Native Apps FROM WITHIN WORDPRESS

1. Visit the plugins page within your dashboard and select ‘Add New’;
1. Search for ‘WP Native Apps’;
1. Activate WP Native Apps from your Plugins page;
...
= How does the app get listed on the app store? =
...
If you have installed and configured any other WordPress plugin you should be ok, if you are concerned about the process, please watch our step-by-step [configuration tutorials here](https://wpnativeapps.com/tutorials/).

= How long does it take for the app to go live after it’s published? =
...
= Can I have a custom menu structure for the app? =
...
= Do all websites work with WPNativeApps? =
...
= Does it cost as much as normal app development? =
No no no, not at all!
...
= Will the app look and feel different to my website? =
Yes!
