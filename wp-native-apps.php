 ...
 * Version:           1.0.0
 * Author:            WPNativeApps
 * Author URI:        https://wpnativeapps.com/
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Text Domain:       wp-native-apps
 ...
 * This action is documented in includes/class-wp-native-apps-activator.php
 */
function activate_wp_native_apps() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-wp-native-apps-activator.php';
	Wp_Native_Apps_Activator::activate();
}

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/class-wp-native-apps-deactivator.php
 */
function deactivate_wp_native_apps() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-wp-native-apps-deactivator.php';
 ...
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-wp-native-apps.php';
